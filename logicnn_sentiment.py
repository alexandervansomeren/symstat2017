...
def train_conv_net(datasets,
    ...
    # add logic layer
    nclasses = 2
    rules = [FOL_NT(nclasses, x, f_nt_full)]
    rule_lambda = [1]
    ...
    test_model_all = theano.function([x, y, f_nt_before, f_nt_after, f_nt_ind],
    ...
    while (epoch < n_epochs):
        ...
        print(
            ...
            (epoch, time.time() - start_time, train_q_perf * 100., val_q_perf * 100., train_p_perf * 100.,
             val_p_perf * 100.))
        print test_fea.keys()
        test_loss = test_model_all(test_set_x, test_set_y, test_fea['nt_before'],
...
if __name__ == "__main__":
    ...
    # datasets[3] = datasets[3]  # but
    # datasets[4] = datasets[4]
    # datasets[5] = datasets[5]
    datasets[6] = datasets[6][:train_size]
    # datasets[7] = datasets[7][:dev_size]
    # datasets[8] = datasets[8][:test_size]
    # print U.shape  -> (17238, 300)
