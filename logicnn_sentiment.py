...
if __name__ == "__main__":
    ...
    np.random.seed(1)
    indices = np.random.choice(76961, train_size)
    ...
    print 'student network p: ', str(np.mean(p_results))
    print "Q Results:"
    for r in q_results:
        print r
    print "P Results:"
    for r in p_results:
        print r
    print "Max q: ", str(np.max(q_results))
    print "Max p: ", str(np.max(p_results))